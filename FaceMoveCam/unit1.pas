...
begin
  ...
  ClassCascade:=nil;
  ReadConfig;
  cvInitFont(@MyTextFont, CV_FONT_HERSHEY_COMPLEX, 0.8, 0.8, 0, 1, CV_AA);
...
begin
  ...
  begin
    ...
    begin
      ...
      cvRectangle(MyInputImage, inputPt1, inputPt2, cColor, 2, 8, 0);
      cvPutText(MyInputImage, 'HUMANO', cvPoint(inputPt1.x + Trunc(ObjectOutimage^.width * 0.18), inputPt1.y - 30), @MyTextFont, cColor);
    end
   else
   begin
